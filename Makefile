...
MINISAT_CXXFLAGS = -I../local/include -I. -D __STDC_LIMIT_MACROS -D __STDC_FORMAT_MACROS -Wall -Wno-parentheses -Wextra 
MINISAT_LDFLAGS  = -Wall -L../local/lib -lpolybori_groebner -lpolybori -lm4ri -lpng -lz
